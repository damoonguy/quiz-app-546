...
let cpasswordInput = document.getElementById('confirmPassword');
let cpwLabel = document.getElementById('confirmPasswordLabel');
...
if (registrationForm) {
    registrationForm.addEventListener('submit', (event) => {
        ...
        if (passwordInput && cpasswordInput) {
            ...
            cpasswordInput = validation.checkString(cpasswordInput);
